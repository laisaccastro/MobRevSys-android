...
import com.mobilerevis.laisa.Type.PaperDivisionType;
import com.mobilerevis.laisa.Type.RoleType;
import com.mobilerevis.laisa.Type.StageType;
import com.mobilerevis.laisa.entidades.BibFile;
import com.mobilerevis.laisa.entidades.Criteria;
import com.mobilerevis.laisa.entidades.Reviewer;
...
final CharSequence[] roles = new CharSequence[]{"SELECTION", "REVIEW"};
    ...
    private PaperDivisionType divisionType = PaperDivisionType.ALL;
    ...
    public void createRS() {
        ...
        for(ReviewerRole rr: srev.getParticipatingReviewers()){
            rr.setSystematicReview(srev);
        }
